                    <h3 class="page-title"> Data Recharge </h3>
<div class="row">
                        <div class="col-md-12">
                                                ...
                                                <ul class="nav nav-pills nav-justified steps">
                                                    <li>
                                                        <a href="#tab1" data-toggle="tab" class="step">
                                                            ...
                                                            <span class="desc">
                                                                <i class="fa fa-check"></i> TopUp Bundle Setup </span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab1">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Network
                                                                <span class="required"> * </span>
                                                            </label>
                                                            <div class="col-md-4">
                                                                <select name="network">
																	<option value="">Select a network</option>
																	<option value="2353">GLO Bundle</option>																
																</select>
                                                                <span class="help-block"> Provide your preferred provider </span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Bundle Type
                                                                <span class="required"> * </span>
                                                            </label>
                                                            <div class="col-md-4">
                                                                 <select name="bundle">
																	<option value="">Select a package</option>
																	<option value="1353">1500 nite plan bundle</option>																
																</select>
                                                                <span class="help-block"> Provide your exact bundle your want to topup. </span>
                                                            </div>
                                                        </div>
														 <div class="form-group">
													...
													<div class="form-group">
                                                            <label class="control-label col-md-3">Bundle Type:</label>
                                                            <div class="col-md-4">
                                                                <p class="form-control-static" data-display="bundle"> </p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
