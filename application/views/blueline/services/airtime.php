                    <h3 class="page-title"> Airtime Recharge</h3>
<div class="row">
                        <div class="col-md-12">
                                                ...
                                                <ul class="nav nav-pills nav-justified steps">
                                                    <li>
                                                        <a href="#tab1" data-toggle="tab" class="step">
                                                            ...
                                                            <span class="desc">
                                                                <i class="fa fa-check"></i> Recharge Setup </span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select name="network">
																	...
																	<option value="2353">MTN VTU</option>																
																</select>
                                                                <span class="help-block"> Provide your preferred nework </span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control" name="amount" id="submit_form_amount" />
                                                                <span class="help-block"> Provide your exact amount your want to recharge. </span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
