...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md page-sidebar-closed">
                ...
                <div class="page-top">
                    ...
                    <div class="top-menu">
                        ...
                        <li class="dropdown dropdown-extended dropdown-tasks">
                            <div style="padding: 25px 6px 13px 15px;">
                                <span class="username username-hide-on-mobile"> You're welcome!</span>
                            </div>
                        </li>       
        ...
        <div class="page-footer">
            <div class="col-md-12 page-footer-inner text-center"> Copyrights <?php 
$copyYear = 2017; 
$curYear = date('Y'); 
echo $copyYear . (($copyYear != $curYear) ? '-' . $curYear : '');
?> &copy; All rights reserved. Created by <?=humanize($core_settings->company);?>.
            </div>
